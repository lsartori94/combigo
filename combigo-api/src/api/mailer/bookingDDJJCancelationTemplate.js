...
function setVariables(origin, destination, date, hour, ammount) {
  originStr = origin;
  ...
  * {
  ...
  <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
    <div role="banner">
      ...
      <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
        <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #41637e;font-family: Avenir,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
          <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 300px;" src="https://cdn.discordapp.com/attachments/817795822522859521/839844690849169418/logo_is.png" alt="" width="300" /></div>
        </div>
      <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
      </div>
    </div>
    ...
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
      <h1 style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #418812;font-size: 40px;line-height: 47px;text-align: center;"><strong>Su viaje ha sido cancelado</strong></h1>
    </div>
  </div>
      
          <div style="Margin-left: 20px;Margin-right: 20px;">
    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
      <p style="Margin-top: 0;Margin-bottom: 20px;text-align: center;">Tu reserva del viaje de ${originStr} a ${destinationStr} para la fecha ${dateStr} y hora ${hourStr} ha sido cancelado por caso sospechoso.</p>
      <p style="Margin-top: 0;Margin-bottom: 20px;text-align: center;">El ${ammountStr} del precio del pasaje ha sido reintegrado a tu tarjeta.</p>
      <p style="Margin-top: 0;Margin-bottom: 20px;text-align: center;">Gracias por elegirnos!</p>
    </div>
  </div>
